...
void machine::Controller::loop()
{
    switch (action_)
    {
        ...
        case MOVE:
        {
//            if (!motor::CONTROLLER.moving_) action_ = NONE;
//            break;
        }
        case OPEN:
        {
...
{
    valve::CONTROLLER.open(valve, timeVal);
//    valve::CONTROLLER.open(2, 200);
//    valve::CONTROLLER.open(3, 200);
//    valve::CONTROLLER.open(8, 200);
//    valve::CONTROLLER.open(9, 200);
