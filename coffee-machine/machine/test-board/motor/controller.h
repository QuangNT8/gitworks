...
{
public:
    enum Command{NONE=0, CALIBRATE, UPDATE_STATE, READ_ANGLE, UPDATE_CURRENT, PLOT_DATA};
    enum State{UNKNOWN = 0, CAL_CURRENT_OFFSET, WAIT_FOR_STABILITY, FORWARD_TO_ZERO,BACKWARD_TO_ZERO, MOVE_TO_HOME, HOMING, STOP, MOVING};
...
private:
    ...
    uint16_t iaOffset_ = 2998, ibOffset_ = 2969;
