...
Module
{
    ...
    cpp.driverFlags:
    [
        "-mlittle-endian", "-mcpu=cortex-m0",  "-march=armv6-m", "-mthumb", "-specs=nano.specs", "-specs=nosys.specs"
    ]
    ...
    Rule
    {
        ...
        prepare:
        {
            ...
            var cmdSize = new Command(project.gccPath+"arm-none-eabi-size.exe", argsSize)
