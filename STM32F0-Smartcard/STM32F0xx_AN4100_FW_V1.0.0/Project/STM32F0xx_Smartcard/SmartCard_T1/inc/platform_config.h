/**
  ******************************************************************************
  * @file    Smartcard_T1/inc/platform_config.h 
...
/* Define the STM32F0xx hardware depending on the used evaluation board */
...
#define T1_USART_IRQHandler                USART1_IRQHandler
...
#define SC_3_5V_GPIO_CLK                   RCC_AHBPeriph_GPIOA

#define SC_RESET_PIN                       GPIO_Pin_15
#define SC_RESET_GPIO_PORT                 GPIOB
#define SC_RESET_GPIO_CLK                  RCC_AHBPeriph_GPIOB

#define SC_CMDVCC_PIN                      GPIO_Pin_13
#define SC_CMDVCC_GPIO_PORT                GPIOC
#define SC_CMDVCC_GPIO_CLK                 RCC_AHBPeriph_GPIOC

#define SC_OFF_PIN                         GPIO_Pin_11
#define SC_OFF_GPIO_PORT                   GPIOA
#define SC_OFF_GPIO_CLK                    RCC_AHBPeriph_GPIOA
#define SC_OFF_EXTI_LINE                   EXTI_Line11
#define SC_OFF_EXTI_PORT_SOURCE            EXTI_PortSourceGPIOA
#define SC_OFF_EXTI_PIN_SOURCE             EXTI_PinSource11
